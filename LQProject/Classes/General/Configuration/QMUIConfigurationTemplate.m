...
#pragma mark - Global Color
    ...
    QMUICMI.blueColor = [UIColor colorWithRed:58/255.0 green:151/255.0 blue:255/255.0 alpha:1.0];                              // UIColorBlue : 蓝色
    ...
    QMUICMI.backgroundColor = UIColorMake(248, 248, 248);                       // UIColorForBackground : 界面背景色，默认用于 QMUICommonViewController.view 的背景色
    ...
    QMUICMI.separatorColor = [UIColor qmui_colorWithHexString:@"#eeeeee"];                        // UIColorSeparator : 全局默认的分割线颜色，默认用于列表分隔线颜色、UIView (QMUI_Border) 分隔线颜色
...
#pragma mark - UIButton
    ...
    QMUICMI.buttonTintColor = UIColorMakeWithHex(@"#333");                              // ButtonTintColor : QMUIButton 默认的 tintColor，不影响系统的 UIButton
...
#pragma mark - NavigationBar
    ...
    // CAUTION:此处navBarBackgroundImage若设为nil，navigationBar的translucent属性会为yes，会导致weex页面从屏幕顶部开始布局！设置navBarBackgroundImage后，translucent会为no
    // navigationBar的translucent为yes时，布局会从屏幕顶部开始。布局统一采用translucent设为NO，extendedLayoutIncludesOpaqueBars设为YES的方式使布局从顶部开始
    QMUICMI.navBarBackgroundImage = [[UIImage qmui_imageWithColor:UIColorWhite] resizableImageWithCapInsets:UIEdgeInsetsMake(0, 2, 0, 2)]; // NavBarBackgroundImage : UINavigationBar 的背景图
//    QMUICMI.navBarBackgroundImage = nil; // NavBarBackgroundImage : UINavigationBar 的背景图
    QMUICMI.navBarShadowImage = [UIImage imageNamed:@"navibar_shadow"];                              // NavBarShadowImage : UINavigationBar.shadowImage，也即导航栏底部那条分隔线
...
#pragma mark - TableView / TableViewCell
    ...
    QMUICMI.tableViewGroupedBackgroundColor = UIColorMake(248, 248, 248);       // TableViewGroupedBackgroundColor : Grouped 类型的 QMUITableView 的背景色
    ...
    QMUICMI.tableViewCellDisclosureIndicatorImage = [UIImage qmui_imageWithShape:QMUIImageShapeDisclosureIndicator size:CGSizeMake(6, 10) lineWidth:1 tintColor:APPColor_BBB];    // TableViewCellDisclosureIndicatorImage : QMUITableViewCell 当 accessoryType 为 UITableViewCellAccessoryDisclosureIndicator 时的箭头的图片
    QMUICMI.tableViewCellCheckmarkImage = [UIImage imageNamed:@"icon_selected"];  // TableViewCellCheckmarkImage : QMUITableViewCell 当 accessoryType 为 UITableViewCellAccessoryCheckmark 时的打钩的图片
    ...
    QMUICMI.tableViewSectionHeaderFont = UIFontMake(12);                                            // TableViewSectionHeaderFont : Plain 类型的 QMUITableView sectionHeader 里的文字字体
    QMUICMI.tableViewSectionFooterFont = UIFontMake(12);                                            // TableViewSectionFooterFont : Plain 类型的 QMUITableView sectionFooter 里的文字字体
    QMUICMI.tableViewSectionHeaderTextColor = APPColor_Text_888;                                             // TableViewSectionHeaderTextColor : Plain 类型的 QMUITableView sectionHeader 里的文字颜色
    QMUICMI.tableViewSectionFooterTextColor = APPColor_Text_888;                                              // TableViewSectionFooterTextColor : Plain 类型的 QMUITableView sectionFooter 里的文字颜色
    QMUICMI.tableViewSectionHeaderContentInset = UIEdgeInsetsMake(20, 15, 15, 15);                        // TableViewSectionHeaderContentInset : Plain 类型的 QMUITableView sectionHeader 里的内容的 padding
    QMUICMI.tableViewSectionFooterContentInset = UIEdgeInsetsMake(20, 15, 15, 15);                        // TableViewSectionFooterContentInset : Plain 类型的 QMUITableView sectionFooter 里的内容的 padding
    QMUICMI.tableViewSectionHeaderAccessoryMargins = UIEdgeInsetsMake(0, 0, 0, 0); // TableViewSectionHeaderAccessoryMargins : Plain 类型的 QMUITableView sectionHeader accessoryView 的间距
    QMUICMI.tableViewSectionFooterAccessoryMargins = UIEdgeInsetsMake(0, 0, 0, 0); // TableViewSectionFooterAccessoryMargins : Plain 类型的 QMUITableView sectionFooter accessoryView 的间距
    QMUICMI.tableViewGroupedSectionHeaderAccessoryMargins = UIEdgeInsetsMake(0, 0, 0, 0); // TableViewGroupedSectionHeaderAccessoryMargins : Grouped 类型的 QMUITableView sectionHeader accessoryView 的间距
    QMUICMI.tableViewGroupedSectionFooterAccessoryMargins = UIEdgeInsetsMake(0, 0, 0, 0); // TableViewGroupedSectionFooterAccessoryMargins : Grouped 类型的 QMUITableView sectionFooter accessoryView 的间距
    ...
    QMUICMI.tableViewGroupedSectionHeaderTextColor = APPColor_Text_888;                                 // TableViewGroupedSectionHeaderTextColor : Grouped 类型的 QMUITableView sectionHeader 里的文字颜色
    QMUICMI.tableViewGroupedSectionFooterTextColor = APPColor_Text_888;                                       // TableViewGroupedSectionFooterTextColor : Grouped 类型的 QMUITableView sectionFooter 里的文字颜色
    ...
    QMUICMI.tableViewGroupedSectionHeaderContentInset = UIEdgeInsetsMake(20, 15, 15, 15);    // TableViewGroupedSectionHeaderContentInset : Grouped 类型的 QMUITableView sectionHeader 里的内容的 padding
    QMUICMI.tableViewGroupedSectionFooterContentInset = UIEdgeInsetsMake(20, 15, 15, 15);                 // TableViewGroupedSectionFooterContentInset : Grouped 类型的 QMUITableView sectionFooter 里的内容的 padding
