...
#pragma mark - NavigationBar
    ...
    QMUICMI.navBarBackgroundImage = [[UIImage qmui_imageWithColor:QMUICMI.blueColor] resizableImageWithCapInsets:UIEdgeInsetsMake(0, 2, 0, 2)];                                        // NavBarBackgroundImage : UINavigationBar 的背景图
